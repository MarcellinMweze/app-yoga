...
// Fonction qui se lance seul au demarrage
  ...
  lobby: function () {
    let mapArray = exerciceArray
      .map((exo) => {
        ...
        <i class="fas fa-times-circle deleteBtn data-pic" data-pic=${exo.pic}></i>
      </li>`;
      })
      .join("");
